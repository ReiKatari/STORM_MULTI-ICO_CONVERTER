...
def verify_save_all():
    ...
    try:
        with Image.open(source_img) as img:
            ...
            others = [s256, img.resize((48, 48), Image.Resampling.LANCZOS), img.resize((16, 16), Image.Resampling.LANCZOS)]
            
            # Save: Using save_all=True
            s64.save(out_path, format='ICO', append_images=others, save_all=True)
            print(f"Created {out_path} with save_all=True")
